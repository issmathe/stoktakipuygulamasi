...
import EuroreparHaftalik from "./EuroreparHaftalik";
import EuroreparAylik from "./EuroreparAylik";
import EuroreparGrafik from "./EuroreparGrafik";
  ...
  return (
    <div style={{ padding: "10px" }}>
      <h2 style={{ textAlign: "center", color: "#144b82" }}>
        Toplam Satılan Eurorepar Akü Adeti: {akuAdet.length}
      </h2>
      <div
        style={{
      ...
      <br />
      <div>{isAylikLoading && <EuroreparAylik />}</div>
      <div>{isGrafikLoading && <EuroreparGrafik />}</div>
      <div>{isHaftalikLoading && <EuroreparHaftalik />}</div>
    </div>
  );
};

export default EuroreparSonuc;
