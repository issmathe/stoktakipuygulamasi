...
function EuroreparSatimForm() {
  ...
  const handleSubmit = async (event) => {
    ...
    const existingAku = EuroreparsAkuData.find((item) => item.name === formData.aku);
    ...
    try {
      ...
      await axios.put(
        `${process.env.REACT_APP_SERVER_URL}/api/eurorepar/${existingAku._id}`,
        {
    ...
    <div className="container mt-4">
      <div className="row justify-content-center">
        <div className="col-md-6">
          <h2 className="text-center background">Eurorepar Akü Satım İşlemleri</h2>
...
export default EuroreparSatimForm;
